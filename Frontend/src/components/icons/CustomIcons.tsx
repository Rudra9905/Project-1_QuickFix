...
export const HeadphonesIcon: React.FC<IconProps> = ({ className = '', size = 24, color = '#5B2D8B' }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const QuickFixLogoIcon: React.FC<IconProps> = ({ className = '', size = 24, color = '#5B2D8B' }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CarpentryIcon: React.FC<IconProps> = ({ className = '', size = 24, color = '#5B2D8B' }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Hammer */}
...
// Eye/View Icon
export const EyeIcon: React.FC<IconProps> = ({ className = '', size = 24, color = '#5B2D8B' }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
// Message/Chat Icon
export const MessageIcon: React.FC<IconProps> = ({ className = '', size = 24, color = '#5B2D8B' }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const RescheduleIcon: React.FC<IconProps> = ({ className = '', size = 24, color = '#5B2D8B' }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
