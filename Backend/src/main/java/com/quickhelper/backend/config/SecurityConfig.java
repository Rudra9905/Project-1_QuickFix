...
// Basic stateless security setup with JWT auth, CORS and WebSocket allowances
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(csrf -> csrf
                        .ignoringRequestMatchers("/ws/**") // Allow WebSocket connections
                        .disable()
                )
                .authorizeHttpRequests(auth -> auth
                        // Public endpoints
                        .requestMatchers("/api/auth/**", "/auth/**", "/ws/**", "/uploads/**", "/api/stats", "/api/stats/**", "/api/health/**", "/loaderio-*.txt").permitAll()
